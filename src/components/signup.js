...
class Signup extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      name: '',
      confirmpassword: '',
      formErrors:{emailID:'',name:'',password:'',confirmpassword:''},
            emailValid: false,
            usernameValid:false,
            passwordValid:false,
          ...
          <form onSubmit={this.handleSubmit}>
            ...
            <label>
              <input
                ...
                required
              />
               {(this.state.name.length > 0 && !this.state.usernameValid)?<i className=" warningstyles"></i>:''}
                </label>
              ...
              />
              {(this.state.emailID.length > 0 && !this.state.emailValid)?<i className=" warningstyles"></i>:''}
              </label>
              ...
              <input
                ...
                required
              />
              {(this.state.password.length > 0 && !this.state.passwordValid)?<i className=" warningstyles"></i>:''}
              </label>
              ...
              <input
                ...
                required
              />
              {(this.state.confirmpassword.length > 0 && !this.state.confirmPasswordValid)?<i className=" warningstyles"></i>:''}
              </label>
              ...
              <button className="inputboxsignup" type="submit" disabled={!this.state.formValid}>
                Sign Up
              </button>
            </div>
          </form>
